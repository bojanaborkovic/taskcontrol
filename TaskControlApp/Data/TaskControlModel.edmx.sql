...
-- --------------------------------------------------
-- Date Created: 10/12/2017 09:45:21
...
IF OBJECT_ID(N'[dbo].[FK_Comment_Task]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Comments] DROP CONSTRAINT [FK_Comment_Task];
GO
IF OBJECT_ID(N'[dbo].[FK_dbo_AspNetRoleClaims_dbo_AspNetRoles_RoleId]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[AspNetRoleClaims] DROP CONSTRAINT [FK_dbo_AspNetRoleClaims_dbo_AspNetRoles_RoleId];
GO
...
IF OBJECT_ID(N'[dbo].[FK_Issue_Type]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tasks] DROP CONSTRAINT [FK_Issue_Type];
GO
IF OBJECT_ID(N'[dbo].[FK_Note_Project]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Notes] DROP CONSTRAINT [FK_Note_Project];
GO
IF OBJECT_ID(N'[dbo].[FK_Project_AspNetUsers]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Projects] DROP CONSTRAINT [FK_Project_AspNetUsers];
GO
IF OBJECT_ID(N'[dbo].[FK_Task_AspNetUsers]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tasks] DROP CONSTRAINT [FK_Task_AspNetUsers];
GO
IF OBJECT_ID(N'[dbo].[FK_Task_Priority]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tasks] DROP CONSTRAINT [FK_Task_Priority];
GO
IF OBJECT_ID(N'[dbo].[FK_Task_Project]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tasks] DROP CONSTRAINT [FK_Task_Project];
GO
IF OBJECT_ID(N'[dbo].[FK_Task_Status]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tasks] DROP CONSTRAINT [FK_Task_Status];
GO
IF OBJECT_ID(N'[dbo].[FK_TaskAsigneeHistory_Task]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TaskAsigneeHistories] DROP CONSTRAINT [FK_TaskAsigneeHistory_Task];
GO
IF OBJECT_ID(N'[dbo].[FK_TaskStatusHistory_Task]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TaskStatusHistories] DROP CONSTRAINT [FK_TaskStatusHistory_Task];
GO
...
GO
IF OBJECT_ID(N'[dbo].[TaskAsigneeHistories]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TaskAsigneeHistories];
GO
IF OBJECT_ID(N'[dbo].[Tasks]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Tasks];
GO
IF OBJECT_ID(N'[dbo].[TaskStatusHistories]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TaskStatusHistories];
GO
...
ALTER TABLE [dbo].[AspNetRoleClaims]
ADD CONSTRAINT [FK_dbo_AspNetRoleClaims_dbo_AspNetRoles_RoleId]
    FOREIGN KEY ([RoleId])
...
-- Creating non-clustered index for FOREIGN KEY 'FK_dbo_AspNetRoleClaims_dbo_AspNetRoles_RoleId'
CREATE INDEX [IX_FK_dbo_AspNetRoleClaims_dbo_AspNetRoles_RoleId]
...
ALTER TABLE [dbo].[Notes]
ADD CONSTRAINT [FK_Note_Project1]
    FOREIGN KEY ([ProjectId])
    REFERENCES [dbo].[Projects]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Note_Project1'
CREATE INDEX [IX_FK_Note_Project1]
ON [dbo].[Notes]
    ([ProjectId]);
GO
